  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="brand-kicker">节点管理</p>
          <h2 className="text-xl font-bold text-slate-100">节点列表</h2>
        </div>
        <button
      ...
      <div className="overflow-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            {servers.length === 0 && (
              <tr><td colSpan={4} className="px-4 py-8 text-center text-slate-500">暂无节点</td></tr>
            )}
          </tbody>
        </table>
      </div>
