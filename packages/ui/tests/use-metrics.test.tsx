...
function createMockTransport(): TransportAdapter {
  return {
    ...
    getAlerts: vi.fn(async (_query?: unknown) => [] as AlertRecord[]),
    suppressAlert: vi.fn(async (_id: string, _days?: number) => undefined),
    unsuppressAlert: vi.fn(async (_id: string) => undefined),
    batchSuppressAlerts: vi.fn(async (_ids: string[], _days?: number) => undefined),
    batchUnsuppressAlerts: vi.fn(async (_ids: string[]) => undefined),
