...
def _load_main_stagger():
    try:
        from pmeow.examples.pytorch_tasks import main_stagger as loaded_main_stagger

        return loaded_main_stagger
        ...
        return module.main_stagger


main_stagger = _load_main_stagger()
